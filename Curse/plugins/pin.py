...
from Curse.utils.string import build_keyboard, parse_button


@app.on_message(command("pin") & admin_filter, group=99008)
...
@app.on_message(command("unpin") & admin_filter, group=99007)
async def unpin_message(c: app, m: Message):
    try:
        if m.reply_to_message:
...
@app.on_message(command("unpinall") & admin_filter, group=99006)
...
@app.on_message(command("antichannelpin") & admin_filter, group=99005)
...
@app.on_message(command("pinned") & admin_filter, group=99004)
async def pinned_message(c: app, m: Message):
...
@app.on_message(command("cleanlinked") & admin_filter, group=99003)
...
@app.on_message(command("permapin") & admin_filter, group=99002)
