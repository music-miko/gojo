...
_DATABASE: AgnosticDatabase = _MGCLIENT["CurseAnime"]
    ...
    async def wrapper(_, message: Message):
            ...
            try:
                ...
                if nut - out < 1.2:
                    ...
                    if USER_WC[user] == 3:
                        ...
                        await clog("Curse", f"UserID: {user}", "SPAM")
                    if USER_WC[user] == 5:
        ...
        try:
            ...
            try:
                ...
                await clog("Curse", e, "FAILURE", msg=message)
        ...
        if user in BOT_OWNER or user == int(cqowner):
            ...
            try:
                ...
                try:
                    ...
                    await clog("Curse", e, "FAILURE", cq=c_q)
        else:
            if cqowner_is_ch:
                if user_valid:
                    try:
...
example: /anime Sword Art Online"""
    ...
    try:
        ...
        await clog("Curse", title_img, "LINK", msg=message)
...
example: /manga Sword Art Online"""
    ...
    try:
        ...
        await clog("Curse", pic, "LINK", msg=message)
        await client.send_photo(gid, failed_pic, caption=finals_, reply_markup=buttons)
...
async def character_cmd(client: Client, message: Message, mdata: dict):
    ...
    try:
        ...
        await clog("Curse", img, "LINK", msg=message)
...
example: /airing Sword Art Online"""
    ...
    try:
        ...
        await clog("Curse", coverImg, "LINK", msg=message)
...
This material is marked 18+ and not allowed in this group""",
    ...
    try:
        ...
        await clog("Curse", pic, "LINK", msg=cq)
        await cq.edit_message_media(
