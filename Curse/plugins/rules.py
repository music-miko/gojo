...
@app.on_message(command("rules") & filters.group, group=1231)
...
@app.on_message(command("setrules") & admin_filter, group=1232)
...
@app.on_message(
    command(["pmrules", "privaterules"]) & admin_filter, group=1233
)
...
@app.on_message(command("clearrules") & admin_filter, group=12345)
